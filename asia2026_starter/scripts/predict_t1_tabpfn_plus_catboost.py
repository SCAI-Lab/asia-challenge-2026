...
def _prepare_base_features(df: pd.DataFrame, base_cols: List[str]) -> pd.DataFrame:
...
def run_one(
    ...
    base_test = _prepare_base_features(Xte, base_cols)
    ...
    for alpha in alphas:
        blended = tabpfn_vals + (alpha * residual)
