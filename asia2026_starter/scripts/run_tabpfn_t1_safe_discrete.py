...
def run_one(
    ...
    method = "tabpfn_25_t1safe_discrete"
    ...
    cfg = RunConfig(
        ...
        notes="t1-safe tabpfn discrete: classifier-as-regressor for sensory targets",
    )
...
def main() -> None:
    ...
    print(f"[asia2026 t1 safe discrete] done -> {out_dir}")
