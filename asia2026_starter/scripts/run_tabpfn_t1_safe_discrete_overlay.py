...
def run_one(
    ...
    method = "tabpfn_t1safe_discrete_overlay"
    ...
    cfg = RunConfig(
        ...
        notes="t1-safe tabpfn discrete overlay: partial seed ensemble on top-missing targets",
    )
    write_json(
        out_dir / "config.json",
        {
...
def main() -> None:
    ...
    print(f"[asia2026 t1 safe discrete overlay] done -> {out_dir}")
