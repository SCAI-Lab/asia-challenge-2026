...
DEFAULT_BASELINE = SUBMISSIONS_DIR / "anchor_corrected_submission.csv"
DEFAULT_FEATURES_TEST = REPOSITORY_ROOT / "data/features_test_2.csv"
DEFAULT_FEATURES_TRAIN = REPOSITORY_ROOT / "data/features_train_2.csv"
...
def main() -> None:
    ...
    pred = pd.read_csv(args.base_csv).sort_values("ID").reset_index(drop=True)
    ...
    method = "extended_anchor_correction"
