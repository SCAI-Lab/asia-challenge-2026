...
DEFAULT_BASELINE = SUBMISSIONS_DIR / "base_model_submission.csv"
...
def main() -> None:
    ...
    pred, w_lr_map, w_ltpp_map, applied_lr, applied_ltpp = _apply_pairwise_shrinkage(
        pred=pred,
    ...
    run_summary = {
        ...
        "notes": "Pairwise shrinkage with gating on test missingness >=0.85 and observed-value copy-through.",
    }
